...
class Block:
    # SA3: Remove receiving transaction parameter
    def __init__(self, index, timestamp, previousHash, transaction):
        self.index = index
    ...
    # SA3: Define transaction function that receives transaction as parameter
        ...
        # SA3: Check if transaction exits
            ...
            # SA3: Check if len of transactions is 3 and then calculate hash
